...
#Le bot va dire bonjour

journalistes.take(5).each do { |user|  } 
client.update("Thank you very much @#{user} for your last article which was very useful to me today")
binding.pry
end



#Le bot va liker bonjour
